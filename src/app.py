...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice soccer skills, teamwork, and compete in matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve basketball fundamentals and play in friendly competitions",
    ...
    "Debate Club": {
        "description": "Practice critical thinking, public speaking, and debate strategy",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
